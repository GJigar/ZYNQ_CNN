...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [31:0]my_net_0_input_r_PORTA_ADDR;
  wire my_net_0_input_r_PORTA_CLK;
  wire [31:0]my_net_0_input_r_PORTA_DIN;
  wire [31:0]my_net_0_input_r_PORTA_DOUT;
  wire my_net_0_input_r_PORTA_EN;
  wire my_net_0_input_r_PORTA_RST;
  wire [3:0]my_net_0_input_r_PORTA_WE;
  wire [31:0]my_net_0_output_r_PORTA_ADDR;
  wire my_net_0_output_r_PORTA_CLK;
  wire [31:0]my_net_0_output_r_PORTA_DIN;
  wire [31:0]my_net_0_output_r_PORTA_DOUT;
  wire my_net_0_output_r_PORTA_EN;
  wire my_net_0_output_r_PORTA_RST;
  wire [3:0]my_net_0_output_r_PORTA_WE;
  ...
  design_1_blk_mem_gen_0_1 blk_mem_gen_1
       (.addra(my_net_0_output_r_PORTA_ADDR),
        ...
        .clka(my_net_0_output_r_PORTA_CLK),
        .clkb(axi_bram_ctrl_1_BRAM_PORTA_CLK),
        .dina(my_net_0_output_r_PORTA_DIN),
        .dinb(axi_bram_ctrl_1_BRAM_PORTA_DIN),
        .douta(my_net_0_output_r_PORTA_DOUT),
        .doutb(axi_bram_ctrl_1_BRAM_PORTA_DOUT),
        .ena(my_net_0_output_r_PORTA_EN),
        .enb(axi_bram_ctrl_1_BRAM_PORTA_EN),
        .rsta(my_net_0_output_r_PORTA_RST),
        .rstb(axi_bram_ctrl_1_BRAM_PORTA_RST),
        .wea(my_net_0_output_r_PORTA_WE),
        .web(axi_bram_ctrl_1_BRAM_PORTA_WE));
  design_1_my_net_0_1 my_net_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst_n(rst_ps7_0_100M_peripheral_aresetn),
        .input_r_Addr_A(my_net_0_input_r_PORTA_ADDR),
        .input_r_Clk_A(my_net_0_input_r_PORTA_CLK),
        .input_r_Din_A(my_net_0_input_r_PORTA_DIN),
        .input_r_Dout_A(my_net_0_input_r_PORTA_DOUT),
        .input_r_EN_A(my_net_0_input_r_PORTA_EN),
        .input_r_Rst_A(my_net_0_input_r_PORTA_RST),
        .input_r_WEN_A(my_net_0_input_r_PORTA_WE),
        .output_r_Addr_A(my_net_0_output_r_PORTA_ADDR),
        .output_r_Clk_A(my_net_0_output_r_PORTA_CLK),
        .output_r_Din_A(my_net_0_output_r_PORTA_DIN),
        .output_r_Dout_A(my_net_0_output_r_PORTA_DOUT),
        .output_r_EN_A(my_net_0_output_r_PORTA_EN),
        .output_r_Rst_A(my_net_0_output_r_PORTA_RST),
        .output_r_WEN_A(my_net_0_output_r_PORTA_WE),
        .s_axi_CRTL_BUS_ARADDR(axi_smc_M02_AXI_ARADDR),
        .s_axi_CRTL_BUS_ARREADY(axi_smc_M02_AXI_ARREADY),
        .s_axi_CRTL_BUS_ARVALID(axi_smc_M02_AXI_ARVALID),
        .s_axi_CRTL_BUS_AWADDR(axi_smc_M02_AXI_AWADDR),
        .s_axi_CRTL_BUS_AWREADY(axi_smc_M02_AXI_AWREADY),
        .s_axi_CRTL_BUS_AWVALID(axi_smc_M02_AXI_AWVALID),
        .s_axi_CRTL_BUS_BREADY(axi_smc_M02_AXI_BREADY),
        .s_axi_CRTL_BUS_BRESP(axi_smc_M02_AXI_BRESP),
        .s_axi_CRTL_BUS_BVALID(axi_smc_M02_AXI_BVALID),
        .s_axi_CRTL_BUS_RDATA(axi_smc_M02_AXI_RDATA),
        .s_axi_CRTL_BUS_RREADY(axi_smc_M02_AXI_RREADY),
        .s_axi_CRTL_BUS_RRESP(axi_smc_M02_AXI_RRESP),
        .s_axi_CRTL_BUS_RVALID(axi_smc_M02_AXI_RVALID),
        .s_axi_CRTL_BUS_WDATA(axi_smc_M02_AXI_WDATA),
        .s_axi_CRTL_BUS_WREADY(axi_smc_M02_AXI_WREADY),
        .s_axi_CRTL_BUS_WSTRB(axi_smc_M02_AXI_WSTRB),
        .s_axi_CRTL_BUS_WVALID(axi_smc_M02_AXI_WVALID));
