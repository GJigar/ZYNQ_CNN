...
// ==============================================================
#ifndef __my_net_am_addmul_g8j__HH__
#define __my_net_am_addmul_g8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(my_net_am_addmul_g8j) {
    ...
    SC_CTOR(my_net_am_addmul_g8j):  simcore_am_0_U ("simcore_am_0_U") {
