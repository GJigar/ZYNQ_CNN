...
// ==============================================================
#ifndef __my_net_sitofp_32nkbM__HH__
#define __my_net_sitofp_32nkbM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(my_net_sitofp_32nkbM) {
    ...
    SC_CTOR(my_net_sitofp_32nkbM):  ACMP_sitofp_U ("ACMP_sitofp_U") {
