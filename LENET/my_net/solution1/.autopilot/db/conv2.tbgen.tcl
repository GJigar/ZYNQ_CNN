...
set C_modelArgList {
	...
	{ input_offset int 5 regular  }
	{ weight_offset int 6 regular  }
	{ output_r int 16 regular {array 100 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_r", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "input_offset", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	{ "Name" : "weight_offset", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ input_offset sc_in sc_lv 5 signal 1 } 
	{ weight_offset sc_in sc_lv 6 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "input_offset", "role": "default" }} , 
 	{ "name": "weight_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "weight_offset", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.my_net_hadd_16ns_cud_U17", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.my_net_hmul_16ns_dEe_U18", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.my_net_am_addmul_g8j_U19", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "31221", "Max" : "31221"}
	, {"Name" : "Interval", "Min" : "31221", "Max" : "31221"}
]}
...
set Spec2ImplPortList { 
	...
	input_offset { ap_none {  { input_offset in_data 0 5 } } }
	weight_offset { ap_none {  { weight_offset in_data 0 6 } } }
